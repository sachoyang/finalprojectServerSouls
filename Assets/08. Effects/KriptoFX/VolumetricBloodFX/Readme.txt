...
4) For mobile devices you have to do "texture override for android -> RGBA half/RGB9e5", because by default unity used RGBM encoding for android and this format does not work correctly.

------------------------------------------------------------------------------------------------------------------------------------------

Effects using:

1) Instantiate effect:
